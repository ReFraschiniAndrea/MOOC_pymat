"""
    Lexer for Python imitating Colab.
"""
...
class ColabPythonLexer(RegexLexer):
    """
    Custom modification of the deffault Python3 lexer to allow more expressive
    coloring of keywords, to better resemble Colab's appearence.
    """
    ...
    tokens = {
        'root': [
            ...
            (r'(def)((?:\s|\\\s)+)', bygroups(Keyword.Definition, Whitespace), 'funcname'),
            (r'(class)((?:\s|\\\s)+)', bygroups(Keyword.Definition, Whitespace), 'classname'),
