...
Once you're signed in, you can create a new empty notebook by clicking on  \textbf{“File > New Notebook”} button on the top left; this will save the new notebook in your Google Drive and open it in a new tab at the same time.
\begin{figure}[h]
    \begin{annotatedFigure}
    ...
    \end{annotatedFigure}
    % \caption{Google Colab welcome page. The Signg In In button is on the top right.}
\end{figure}
...
\begin{figure}[h]
    \begin{annotatedFigure}
        ...
        \annotatedFigureBoxCustom{0.1301,0.6575}{0.267,0.7165}{1}{0.1301,0.6575}{amaranth}
	    \annotatedFigureBoxCustom{0.1301,0.574}{0.267,0.633}{2}{0.1311,0.574}{amaranth}
    \end{annotatedFigure}
    % \caption{Prompt window that opens when returning gto the Colab home page or by clicking \texttt{File > Open notebook}.}
\end{figure}
